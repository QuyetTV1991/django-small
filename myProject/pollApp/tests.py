...
def create_question(question_text, days):
    ...
    for the questions that have yet to be published)
    """
...
class QuestionIndexViewTests(TestCase):
    ...
    def test_past_question(self):
        ...
        response = self.client.get(reverse('pollApp:index'))
        self.assertQuerySetEqual(response.context['question_lists'], [question])
    ...
    def test_two_past_questions(self):
        ...
        response = self.client.get(reverse('pollApp:index'))
        self.assertQuerySetEqual(response.context['question_lists'], [question2, question1])
